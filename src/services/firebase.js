...
import { getDatabase, ref, set, onDisconnect, onChildAdded, onChildChanged, onChildRemoved, update } from 'firebase/database';
...
export const subscribeToPlayers = (onPlayerAdded, onPlayerMoved, onPlayerRemoved) => {
  try {
    ...
    const childRemovedUnsubscribe = onChildRemoved(playersRef, (snapshot) => {
      console.log('Player removed:', snapshot.key);
